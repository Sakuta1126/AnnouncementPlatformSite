                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <form method="post" enctype="multipart/form-data"
                                        action="<?php echo ROOT_URL; ?>users/save">
                                        <div class="mb-3 col-4">
                                            <label class="w-100" for="pfpInput">
                                                <img id="pfpImg"
                                                    class="w-100 object-fit-cover border border-1 border-dark shadow"
                                                    alt="zdjęcie profilowe"
                                                    src="<?php echo ROOT_URL . $user_data['pfp']; ?>">
                                            </label>
                                            <input id="pfpInput" type="file" name="pfp" class="d-none"
                                                accept=".jpg, .jpeg, .png">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="NumberInput"
                                                ...
                                                value="<?php echo $user_data['telephone_number']; ?>">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="CurrentOccupationInput"
                                                class="form-label">CurrentOccupation</label>
                                            <textarea class="form-control" id="CurrentOccupationInput"
                                                name="currnent_occupation">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <form method="post" action="<?php echo ROOT_URL; ?>users/save">
                                        ...
                                        <div class="mb-3">
                                            <label for="WorkPeriodStartInput" class="form-label">Working
                                                Period-Start</label>
                                            <input type="date" class="form-control" id="WorkPeriodStartInput"
                                                name="period_start">
                                        </div>
                                        <div class="mb-3">
                                            <label for="WorkPeriodEndInput" class="form-label">Working
                                                Period-End</label>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                            ...
                                                            entity_id="<?php echo $experience['experience_id'] ?>">
                                                            Edytuj
                                                        </button>
                                                    </p>
                                                </div>
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <form method="post" action="<?php echo ROOT_URL; ?>users/save">
                                        ...
                                        <div class="mb-3">
                                            <label for="EducationStartInput" class="form-label">Education
                                                Period-Start</label>
                                            <input type="date" class="form-control" id="EducationStartInput"
                                                name="period_start">
                                        </div>
                                        <div class="mb-3">
                                            <label for="EducationEndInput" class="form-label">Education
                                                Period-End</label>
                                            ...
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                            data-bs-target="#staticBackdrop"
                                                            entity_id="<?php echo $education['education_id'] ?>">
                                                            Edytuj
                                                        </button>
                                                    </p>
                                                </div>
                                        ...
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#staticBackdrop"
                                                        entity_id="<?php echo $language['language_id'] ?>">
                                                        Edytuj
                                                    </button>
                                                </p>
                                            </div>
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <?php foreach ($user_skill as $skill): ?>
                                    <div>
                                        ...
                                        <?php echo $skill['name'] ?>;
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdrop" entity_id="<?php echo $skill['skill_id'] ?>">
                                            Edytuj
                                        </button>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <?php foreach ($user_course as $course): ?>
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdrop" entity_id="<?php echo $course['course_id'] ?>">
                                            Edytuj
                                        </button>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <?php foreach ($user_link as $link): ?>
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdrop" entity_id="<?php echo $link['link_id'] ?>">
                                            Edytuj
                                        </button>
                                    </div>
                                <?php endforeach; ?>
