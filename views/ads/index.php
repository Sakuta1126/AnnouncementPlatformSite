                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="category_id" name="category_id">
                        ...
                        <?php foreach($categories as $category):?>
                            <option value="<?php echo $category['category_id']?>" <?php echo (isset($post['category_id']) && $post['category_id'] == $category['category_id'])? "selected":""?>><?php echo $category['name'] ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="mb-3">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 p-3 bg-light text-center">
            <div class="mb-3">
                ...
                <select class="form-select" id="position_level" name="position_level">
                    ...
                    <option value="Specjalista (Mid/Regular)" <?php echo ($isSet && $post['position_level'] == "Specjalista (Mid/Regular)")? "selected":""?>>Specjalista (Mid/Regular)</option>
                    ...
                    <option value="Ekspert" <?php echo ($isSet && $post['position_level'] == "Ekspert")? "selected":""?>>Ekspert</option>
                    ...
                    <option value="Prezes" <?php echo ($isSet && $post['position_level'] == "Prezes")? "selected":""?>>Prezes</option>
